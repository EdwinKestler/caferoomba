...
| Colab Enterprise training | CPU smoke on `caferoomba-cpu`: 46 tests + synthetic `demo-fixture` + GCS copy | See [Colab Enterprise](COLAB_ENTERPRISE.md). Not GPU/FPV training |
